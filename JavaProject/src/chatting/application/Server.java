...
public class Server implements ActionListener{
    ...
    Server(){
        ...
        p1 = new JPanel();
        p1.setLayout(null);
        p1.setBackground(new Color(2, 119, 189));
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/bond.jpg"));
       ...
       JLabel l3 = new JLabel("James Bond");
       l3.setFont(new Font("MAGNETO", Font.BOLD, 18));
       ...
       l4.setFont(new Font("f", Font.PLAIN, 14));
       ...
       a1.setFont(new Font("CONSOLAS", Font.PLAIN, 16));
       f1.add(a1);
       ...
       b1.setBackground(new Color(209, 237, 242));
       b1.setForeground(Color.BLACK);
       b1.setFont(new Font("CONSOLAS", Font.BOLD, 20));
       b1.addActionListener(this);
       f1.add(b1);
        
       f1.getContentPane().setBackground(new Color(2, 119, 189));
       f1.setLayout(null);
       f1.setSize(450, 700);
       f1.setLocation(200, 20); 
